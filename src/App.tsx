      ...
      <nav className="site-nav" style={{
        ...
        <div className="site-nav-social" style={{ display: 'flex', gap: '14px', alignItems: 'center', justifyContent: 'flex-end' }}>
          {[
            ...
            { href: 'https://mail.google.com/mail/?view=cm&fs=1&to=shaikmohamedashfaq@gmail.com', title: 'Email', svg: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m2 7 10 7 10-7"/></svg> },
          ].map(({ href, title, svg }) => (
            <a key={title} href={href} target="_blank" rel="noopener noreferrer" title={title} {...hov}
            ...
            <div style={{ borderTop: '1px solid rgba(10,9,8,0.07)', paddingTop: '40px' }}>
              ...
              <div className="about-grid" style={{ display: 'grid', gridTemplateColumns: '1.3fr 1fr', gap: '64px', alignItems: 'start' }}>
                ...
                <div>
                  ...
                  <a href="https://mail.google.com/mail/?view=cm&fs=1&to=shaikmohamedashfaq@gmail.com" target="_blank" rel="noopener noreferrer"
                    style={{
